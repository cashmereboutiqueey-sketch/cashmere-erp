...
export default function POSPage() {
    ...
    useEffect(() => {
        ...
        // Fetch Customers
        fetch('http://127.0.0.1:8000/api/brand/customers/', {
            headers: { 'Authorization': `Bearer ${token}` }
        })
            .then(res => res.json())
            .then(data => {
        ...
        // Fetch Locations
        fetch('http://127.0.0.1:8000/api/brand/locations/', {
            headers: { 'Authorization': `Bearer ${token}` }
        })
            .then(res => res.json())
            .then(data => {
        ...
        // Fetch Categories
        fetch('http://127.0.0.1:8000/api/brand/categories/', {
            headers: { 'Authorization': `Bearer ${token}` }
        })
            .then(res => res.json())
            .then(data => {
    ...
    const handleCreateCustomer = async () => {
        ...
        try {
            const res = await fetch('http://127.0.0.1:8000/api/brand/customers/', {
                method: 'POST',
    ...
    const handleRequestProduction = async () => {
        ...
        try {
            ...
            const res = await fetch('http://127.0.0.1:8000/api/factory/jobs/', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    name: jobName,
    ...
    const handleCheckout = async () => {
        ...
        try {
            ...
            const res = await fetch('http://127.0.0.1:8000/api/brand/orders/', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
            ...
            if (isMadeToOrder) {
                const jobPromises = cart.map(item =>
                    fetch('http://127.0.0.1:8000/api/factory/jobs/', {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({
...
function ReturnsModal({ isOpen, onClose, t }: { isOpen: boolean, onClose: () => void, t: any }) {
    ...
    const handleSearch = async () => {
        ...
        try {
            let url = `http://127.0.0.1:8000/api/brand/orders/?search=${searchQuery}`;
    ...
    const handleSubmitReturn = async () => {
        ...
        try {
            const res = await fetch(`http://127.0.0.1:8000/api/brand/orders/${foundOrder.id}/return_items/`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
