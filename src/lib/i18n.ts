...
export const translations = {
  en: {
    ...
    contributionMarginDesc: 'The amount each unit contributes to covering fixed costs.',
    perUnit: 'Per Unit',
  ...
  ar: {
    ...
    contributionMarginDesc: 'المبلغ الذي تساهم به كل وحدة في تغطية التكاليف الثابتة.',
    perUnit: 'لكل وحدة',
